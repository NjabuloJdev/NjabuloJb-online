...
📥 *Format:* MP4
        ...
        return await client.sendMessage(message.from, {
          text: "*minibot* " + toFancyFont("couldn't process your request. Please try again later"),
          mentions: [message.sender]
        }, { quoted: message });
      }
      ...
      try {
        ...
        return await client.sendMessage(message.from, {
          text: "*minibot* " + toFancyFont("failed to send video file"),
          mentions: [message.sender]
        }, { quoted: message });
      }
    }
    ...
    await client.sendMessage(message.from, {
      text: "*mini bot* " + toFancyFont("encountered an error. Please try again"),
      mentions: [message.sender]
    }, { quoted: message });
  }
};
